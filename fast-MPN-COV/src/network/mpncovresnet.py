...
model_urls = {
    'mpncovresnet50': 'https://drive.google.com/u/0/uc?export=download&confirm=NByd&id=19TWen7p9UDyM0Ueu9Gb22NtouR109C6j',
...
def mpncovresnet50(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        model.load_state_dict(torch.load('/home/nemo/VRDL2021/HW1_Fine_Grained/fast-MPN-COV/pretrained/mpncovresnet50.pth'))
    return model
